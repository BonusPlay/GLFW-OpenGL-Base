...
if(NOT ${fname} MATCHES (.=)(bz2tartgztar.gzzip)$)
  string(REGEX MATCH ([^]+(.=)(bz2tartgztar.gzzip)).$ match_result ${URL})
  set(fname ${CMAKE_MATCH_1})
endif()
if(NOT ${fname} MATCHES (.=)(bz2tartgztar.gzzip)$)
  message(FATAL_ERROR Could not extract tarball filename from urln  ${url})
endif()
...
if(ACTUAL_SHA256 STREQUAL e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855)
  ...
  message(FATAL_ERROR
    ...
    httpsgithub.comneovimneovimwikiBuilding-Neovim#build-prerequisites 
