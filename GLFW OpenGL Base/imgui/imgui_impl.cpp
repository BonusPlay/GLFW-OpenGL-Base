...
void ImGui_impl_key_callback (GLFWwindow*, int key, int, int action, int mods)
{
	ImGuiIO& io = ImGui::GetIO ();
...
void ImGui_impl_invalidate_device_objects ()
{
	if (g_VaoHandle)
...
bool ImGui_impl_init (GLFWwindow* window, bool install_callbacks)
{
	ImGui::CreateContext();
	g_Window = window;
...
{
	ImGui_impl_invalidate_device_objects ();
